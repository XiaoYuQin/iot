									 ...
									 <div class="dashbox panel panel-default">
										<div class="panel-body">
										   <div class="panel-left blue">
												...
												<div align="center">
													<img src="../img/icon/user.png" alt="Cloud Admin Logo" class="img-responsive" height="35" width="35"/>
												</div>
										   </div>
										   <div class="panel-right">
										...
										<div class="quick-pie panel panel-default">
											<div class="panel-body">
												<div class="col-md-4 text-center">
													...
													<a href="#" class="title"><font size="2">CPU 占用率</font><i class="fa fa-angle-right"></i></a>
													<div>
														<font size="1">59%</font>
													</div>
												</div>
												<div class="col-md-4 text-center">
													<div id="dash_pie_2" class="piechart" data-percent="33">
														<span class="percent"></span>
													</div>
													<a href="#" class="title"><font size="2">内存使用率</font><i class="fa fa-angle-right"></i></a>
													<div>
														<font size="1">已使用33%</font>
													</div>
												</div>
												<div class="col-md-4 text-center">
													<div id="dash_pie_3" class="piechart" data-percent="30">
														<span class="percent"></span>
													</div>
													<a href="#" class="title"><font size="2">当前带宽</font> <i class="fa fa-angle-right"></i></a>
													<font>已使用带宽30%</font>
												</div>
											</div>
										</div>
