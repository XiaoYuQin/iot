var Popups = 
{
	new:function(map)
	{
		...
		{
			console.info("instence.add = function(id,x,y)");
			var popup = Popup.new();
			popup.init(instence.map,id);
			console.info("popup.init(instence.map,id);");
			// popup.setPosition([x,y]);
			// console.info("popup.setPosition(x,y);");
			instence.popupArray.push(popup);
			console.info("instence.popupArray.push(popup);");
		}
		//从地图中删除一个气泡
